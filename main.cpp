...
struct simpulMhs {
    obj_mhs data;
    Mahasiswa *nextMhs = NULL;
    Mahasiswa *prevMhs = NULL;
...
/**Block Bagian Menghapus Node Mahasiswa
...
/**Block Bagian Sisipkan Mata Kuliah
